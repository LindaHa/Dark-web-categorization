...
export const mockPages = Immutable.Set<IPage>([
  ...
  new Page({id: '9ed26dd9-738a-49f1-91a6-91ed5793fe5d', description: 'Bling some', url: 'bling.onion', categories: Immutable.Set<string>(['guns']), links: Immutable.Set<Uuid>(['bling.onion/guns'])}),
  ...
  new Page({id: 'a07f0as2-8sfb-4a0e-85f6-a037d71a4dd9', description: 'Drive less', url: 'road.onion/porn', categories: Immutable.Set<string>(['guns']), links: Immutable.Set<Uuid>(['xordoquy.onion'])}),
  ...
  new Page({id: 'af35e4ff-93sb-4796-asf1-385ada0392df', description: 'Code faster', url: 'for4.onion/hacking', categories: Immutable.Set<string>(['hacking']), links: Immutable.Set<Uuid>(['wow.onion/hacking'])}),
  new Page({id: 'e12daf5d-ac6b-4acb-b789-s45d43f314d4', description: 'Do some', url: 'blrn.onion', categories: Immutable.Set<string>(['services']), links: Immutable.Set<Uuid>(['blrn.onion/services'])}),
  new Page({id: 'af340a1c-ce9a-4c58-b82c-8d5435ds4daf', description: 'Do better', url: 'blrn.onion/services', categories: Immutable.Set<string>(['services']), links: Immutable.Set<Uuid>(['for4.onion/hacking'])}),
]);
